...
-   A path path to a folder containing one or more images
...
aberrations. If these distortions affect measurement accuracy, calibration of 
the camera and optical system may be required.
...
`WaterStrideR` may work with images from other setups owing ot proper parameter 
tuning.
